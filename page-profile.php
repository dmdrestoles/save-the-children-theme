            ...
            <?php else : ?>
				...
				<div>
					...
					<div class="main-container">
						<div class="profile-pic"><img src="images/pfp.png"></div>
						<form method="post" class="profile-container" id="adduser" action="<?php the_permalink(); ?>">
							<div>
								<div class="profile-info">
									<p class="form-username">
										<label for="first-name" class="first-name"><?php _e('First Name', 'profile'); ?></label>
									...
									<p class="form-username">
										<label for="last-name" class="last-name"><?php _e('Last Name', 'profile'); ?></label>
									...
									<p class="form-email">
										<label for="email" class="email"><?php _e('E-mail *', 'profile'); ?></label>
							...
							<div>
								...
								<div class="change-pw-container">
									...
									<p class="form-submit">
										<?php echo $referer; ?>
										<input name="updateuser" type="submit" id="updateuser" class="submit button saveChanges" value="<?php _e('Update', 'profile'); ?>" />
